...
length(sampling_distribution[sampling_distribution >= 12])/10000
```
Yes, the proportion in question 4 is different from the proportion in question 3. The reason for this is because of the increased sample size. The increase in sample size allows for a larger number of score. Due to the higher concentration of scores close to the mean the proportion in question 4 is different than the proportion in question 3. 
Confidence: 30
