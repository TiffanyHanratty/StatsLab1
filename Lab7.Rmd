...
```
Based on the data there is a 20.26% chance the test-taker received a 60% on the test by randomly guessing. I think this test score could be produced by randomly guessing, but I would consider it fairly unlikely. A 20.26% chance of the test-taker getting 60% on the test by randomly guessing just seems a bit low for me to think it would be highly probable they were just guessing on each answer. 
Confidence: 75
...
binom.test(x = 165,
           ...
           alternative="greater")
```
I think it would be a safe bet for the examiner to use 300 questions to insure scores of 55% or higher were not produced by chance. Using 300 questions would leave a 4.7% chance that a score of 55% or higher was obtained by chance. Considering this is quite a low percentage, and does not seem very likely to happen, I think the examiner should feel repetitively confident about the use of 300 questions. 
Confidence:70
